    ...
    if (message.indexOf("!rlstats") > -1 || message.indexOf("!s") > -1) {
        ...
        if (this._checkMessage(message)) {
            ...
            request(url, function (error, response, body) {
                ...
                if (message.indexOf("watch my rank") < 0 && message.indexOf("watch") < 0 && message.indexOf("w") < 0) {
                
                    if (rankedObject["1v1"] && (message.indexOf("1v1") > -1 || message.indexOf("1") > -1)) {
                        result = "" + rankedObject["1v1"].name + " : " + rankedObject["1v1"].rank + " : " + rankedObject["1v1"].nextDiv;
                    }
                    if (rankedObject["2v2"] && (message.indexOf("2v2") > -1 || message.indexOf("2") > -1)) {
                        result = "" + rankedObject["2v2"].name + " : " + rankedObject["2v2"].rank + " : " + rankedObject["2v2"].nextDiv;
                    }
                    if (rankedObject["3v3"] && (message.indexOf("3v3") > -1 || message.indexOf("3") > -1)) {
                        result = "" + rankedObject["3v3"].name + " : " + rankedObject["3v3"].rank + " : " + rankedObject["3v3"].nextDiv;
                    }
                    if (rankedObject["3v3_solo"] && (message.indexOf("3v3 solo") > -1 || message.indexOf("3s") > -1)) {
                        result = "" + rankedObject["3v3_solo"].name + " : " + rankedObject["3v3_solo"].rank + " : " + rankedObject["3v3_solo"].nextDiv;
                    }
                    if (rankedObject["unranked"] && (message.indexOf("unranked") > -1 || message.indexOf("u") > -1)) {
                        result = "" + rankedObject["unranked"].name + " : " + rankedObject["unranked"].rank + " : " + rankedObject["unranked"].nextDiv;
                    }
